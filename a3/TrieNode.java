...
public class TrieNode {
	 ...
	 * 
	 * ADDED: Nov. 9. If this method is called by the root node, then the empty
	 * string should be returned. The original specification was to return null.
	 * (This specification was not given here, but rather was given in the
	 * Autocomplete.java file.) If your solution uses this specification, you
