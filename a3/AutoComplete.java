...
public class AutoComplete {
	...
	public static void main(String[] args) {
		...
		/*
		 * Test with an input file. Your assignment will be graded using a
		 * different input file, If you wish to share your outputs on the given
		 * input file, that's fine.
		 * 
		 * You will need to put a different pathname in here.
		 * 
		 * String fileName =
		 * "C:\\Program Files\\eclipse\\workspace\\2012\\src\\a3\\inputFile.txt"
		...
		//
		// e.g.: try door, an, cat (should return true, false, and false
		// respectively)

		System.out.println();
		System.out
				.println("---  Test contains() method.   Correct answer shown in brackets. -----");
		System.out.println("trie contains 'door' = " + trie.contains("door")
				+ " (true)");
		System.out.println("trie contains 'and' = " + trie.contains("and")
				+ " (true)");
		System.out.println("trie contains 'cat' = " + trie.contains("cat")
				+ " (false)");
		System.out.println("trie contains 'dog' = " + trie.contains("dog")
				+ " (true)");
		System.out.println("trie contains 'ax' = " + trie.contains("ax")
				+ " (true)");
		System.out.println("trie contains 'dot' = " + trie.contains("dot")
				+ " (true)");
		System.out.println("trie contains 'a' = " + trie.contains("a")
				+ " (true)");
		System.out.println("trie contains 'an' = " + trie.contains("an")
				+ " (false)");
		...
		System.out
				.println("longest prefix of door = " + trie.getPrefix("door"));
		...
		// ex: try a, do, c (should return {a, and, ax}, {dog, door, dot}, null
		// respectively)

		System.out.println("");
		System.out
				.println("-----  Test getAllPrefixMatches()  i.e. autocomplete ");
		System.out.println("autocomplete a = " + trie.getAllPrefixMatches("a"));
		System.out.println("autocomplete do = "
				+ trie.getAllPrefixMatches("do"));
		System.out.println("autocomplete c = " + trie.getAllPrefixMatches("c"));
		System.out.println("autocomplete \"\" = "
				+ trie.getAllPrefixMatches(""));
